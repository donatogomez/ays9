...
class Factory:
    ...
    #     if not config_path:
    #         host = j.core.atyourservice.config['redis'].get('host')
    #         port = j.core.atyourservice.config['redis'].get('port')
    #         unixsocket = j.core.atyourservice.config['redis'].get('unixsocket')
    ...
    #     return Client(unixsocket=j.core.atyourservice.config['redis']['unixsocket'])
